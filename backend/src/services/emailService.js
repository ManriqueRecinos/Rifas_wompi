 ...
 */
async function sendTicketEmail({ to, buyerName, raffleTitle, ticketNumber, pdfBuffer }) {
  ...
  const mailOptions = {
    from:    `"Rifas App" <${process.env.SMTP_USER}>`,
    to,
    subject: `🎟️ Tu ticket #${ticketNumber} para: ${raffleTitle}`,
    html: `
      <div style="font-family:sans-serif;max-width:600px;margin:0 auto;background:#0a0a0a;color:#fff;border-radius:12px;overflow:hidden;">
        ...
        <div style="padding:32px;">
          <p style="color:#ccc;font-size:16px;">Hola <strong style="color:#e8c840">${buyerName || 'participante'}</strong>,</p>
